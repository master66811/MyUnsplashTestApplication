...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.PhotosAdapter> {
    ...
    public class PhotosAdapter extends RecyclerView.ViewHolder {
        CircleImageView item_photo_user_avatar;
        TextView item_photo_username;
        SquareImage item_photo_photo;

        public PhotosAdapter(@NonNull View itemView) {
            super(itemView);
